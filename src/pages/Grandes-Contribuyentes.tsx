...
const GrandesContribuyentes: React.FC = () => {
  ...
  const [selectedGrandesContribuyente, setSelectedGrandesContribuyente] =
    useState<GrandesContribuyentes | null>(null);
  ...
  const grandescontribuyentes: GrandesContribuyentes[] = Array.from(
    { length: 67 },
    (_, i) => ({
      id: i + 1,
  ...
  const filteredGranContribuyente = grandescontribuyentes.filter(
    (grandescontribuyentes) => {
      if (filterType === "Filtros" || filterType === "Todos") return true;
      if (filterType === "Nombre de Fantasia")
        return grandescontribuyentes.nombreFantasia
          .toLowerCase()
          .includes(searchTerm.toLowerCase());
      if (filterType === "Nombre/Razon Social comercio")
        return grandescontribuyentes.nombreRazonSocial
          .toLowerCase()
          .includes(searchTerm.toLowerCase());
      if (filterType === "Calle")
        return grandescontribuyentes.calle
          .toLowerCase()
          .includes(searchTerm.toLowerCase());
      if (filterType === "Barrio")
        return (
          barrioFilter === "" || grandescontribuyentes.barrio === barrioFilter
        );
      if (filterType === "Zona")
        return zonaFilter === "" || grandescontribuyentes.zona === zonaFilter;
      if (filterType === "Activo")
        return (
          activoFilter === "" ||
          grandescontribuyentes.activo.toString() === activoFilter
        );
      return true;
    }
  );
  ...
  const currentComercios = filteredGranContribuyente.slice(
    startIndex,
              ...
              <tbody className="bg-white divide-y">
                {currentComercios.length > 0 ? (
                  currentComercios.map((comercio, index) => (
                    <tr
                      key={comercio.id}
                      className={`hover:bg-gradient-to-r hover:bg-gray-200 transition-all duration-200 ${
                    ...
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <button
                          ...
                          title="Ver detalles"
                          onClick={() =>
                            setSelectedGrandesContribuyente(comercio)
                          }
                        >
            ...
            <div className="bg-slate-600 rounded-xl p-6 w-[700px] shadow-lg relative">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="bg-gray-200 p-2 rounded">
                  Razón Social <br />{" "}
                  <b>{selectedGrandesContribuyente.nombreRazonSocial}</b>
                </div>
                <div className="bg-gray-200 p-2 rounded">
                  Nombre de Fantasía <br />{" "}
                  <b>{selectedGrandesContribuyente.nombreFantasia}</b>
                </div>
                <div className="bg-gray-200 p-2 rounded">
                  Barrio <br /> <b>{selectedGrandesContribuyente.barrio}</b>
                </div>
                <div className="bg-gray-200 p-2 rounded">
                  Calle <br /> <b>{selectedGrandesContribuyente.calle}</b>
                </div>
                <div className="bg-gray-200 p-2 rounded">
                  Zona <br /> <b>{selectedGrandesContribuyente.zona}</b>
                </div>
                <div className="bg-gray-200 p-2 rounded">
                  Activo <br />{" "}
                  <b>{selectedGrandesContribuyente.activo ? "Sí" : "No"}</b>
                </div>
                <div className="bg-gray-200 p-2 rounded">
                  Habilitación Bromatologica <br /> <b>-</b>
                </div>
                <div className="bg-gray-200 p-2 rounded">
                  Habilitación Comercial Municipal <br /> <b>-</b>
                </div>
                <div className="bg-gray-200 p-2 rounded">
                  CUIT <br /> <b>000000000</b>
                </div>
                <div className="bg-gray-200 p-2 rounded">
                  Es movil? <br />{" "}
                  <b>{selectedGrandesContribuyente.activo ? "Sí" : "No"}</b>
                ...
                <div className="bg-gray-200 p-2 rounded">
                  Expediente N° <br /> <b>S/N</b>
                </div>
                <div className="bg-gray-200 p-2 rounded">
                  N° de Suministro <br /> <b>S/N</b>
                </div>
              </div>
            </div>
          </div>

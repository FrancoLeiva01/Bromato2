...
const MapComponent: React.FC = () => {
  ...
  return (
    <LoaderContent
      isLoading={isLoading}
      loadingText="Cargando Marcadores..."
      minHeight="400px"
    >
      <div className="h-screen flex flex-col bg-gray-50 rounded-lg">
            ...
            <div className="flex justify-center items-center gap-3 ">
              ...
              <div>
                ...
                <p className="text-gray-200 text-sm">
                  Haz click en el mapa para agregar una Nueva Ubicación
                </p>
              </div>
        ...
        <div className="flex-1 relative ">
          ...
          >
            ...
            {selectedMarker && (
              <FlyToMarker position={selectedMarker.position} />
            )}
          </MapContainer>
          ...
          {markers.length > 0 && (
            <div className="absolute top-4 right-4 bg-white rounded-lg shadow-lg p-3 z-[1000]">
              <div className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>
                  {markers.length} Ubicación{markers.length !== 1 ? "es" : ""}{" "}
                  marcada{markers.length !== 1 ? "s" : ""}
                </span>
              </div>
            </div>
          )}
